                                ...
                                <div className="w-full bg-darkCard/95 border border-animePurple/30 rounded-xl p-5 shadow-neon-purple/5 shadow-2xl space-y-4 text-xs font-sans text-white select-none">
                                    ...
                                    <div className="space-y-3.5">
                                        ...
                                        {authType === 'mal' ? (
                                            ...
                                            <div className="grid grid-cols-[90px_1fr] items-center gap-2">
                                                <span className="text-[10px] font-orbitron font-bold uppercase tracking-wider text-animePurple-light text-right pr-2">Scoring:</span>
                                                <button 
                                                    type="button"
                                                    onClick={() => window.location.href = 'api/auth.php?action=login'}
                                                    className="w-full py-2 bg-blue-600 hover:bg-blue-500 text-white font-orbitron font-bold text-[10px] tracking-wider rounded flex items-center justify-center space-x-1.5 transition-all active:scale-95 border border-blue-500/25 shadow-md shadow-blue-600/10 cursor-pointer"
                                                >
